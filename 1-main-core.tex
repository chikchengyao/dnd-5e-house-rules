...
Whenever you roll to increase maximum hit points, reroll all natural 1s. You can keep rerolling if you get another natural 1.
...
At character levels 1, 4, 8, 12, 16 and 19, you can take a bonus feat from the Bonus Feats (Single) table (pg.\pageref{bonusFeatsSingleTable}), or a pair of feats from the Bonus Feats (Pair) table (pg.\pageref{bonusFeatsPairTable}). 

You do not benefit from ability score increases from feats taken as a bonus feat.
