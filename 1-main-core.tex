...
\subsection{Actions}
Standard actions are listed in the Actions in Combat table. 
...
Once per turn, you can perform a DC 10 + spell level Intelligence (Arcana) check to identify a spell being cast. The DC is 15 + spell level if the spell is not on one of your class lists.
