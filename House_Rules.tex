...
A creature is flanked when at least two hostiles within 5 feet of it overwhelm its ability to defend itself, by virtue of their positioning and/or number, as determined by the DM. The creature must be aware of hostiles flanking it.
...
The use of Tides of Chaos, inspiration and similar features which instantly grant advantage on a roll can be used in two ways:

\begin{itemize}
	\item before a roll, to gain advantage on the roll, or
	\item after seeing a roll but before knowing the outcome, to reroll one die in the original roll and take the new roll
\end{itemize}
