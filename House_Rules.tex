...
During daily preparations, you prepare spells directly into spell slots, instead of preparing a list of spells.

\begin{DndComment}{Example}
After completing a long rest, a 3rd-level Cleric might have these spells prepared:
...
\noindent This cleric can cast Bless once at 1st level, expending that spell. Her remaining prepared spells are now:
...
\noindent She can cast spells only at the level they were prepared. In this case, she cannot cast \textit{Guiding Bolt} at 2nd level, nor can she cast \textit{Inflict Wounds} at 1st level.
\end{DndComment}

\subsubsection{Action: Reprepare}
Vancian casters can reprepare a spell by taking the Reprepare action a number of times equal to the spell's level. Vancian casters can use the Reprepare action a number of times equal to their level, refreshing on a long rest. 

Reprepare requires concentration. If broken, the repreparation fails, wasting any expended uses of Reprepare.

The Arcane Recovery and Natural Recovery features cause Reprepare uses to refresh on a short rest.

If you have a spell "always prepared", using Reprepare to convert another spell to that spell does not count against your limit.

\subsubsection{Ritual Spells}
Vancian casters can cast a spell as a ritual only if they have it prepared. The ritual spell is cast at the level it was prepared.

Vancian Wizards can ritually cast any spell in their spellbook, as usual.
