...
When you can perceive a spell being cast, you can attempt to use your own magic to disrupt it. You must know the triggering spell or have it prepared. You use your reaction to cast the triggering spell in reverse, expending a spell slot at the same level of the triggering spell or higher, which disrupts the triggering spell.

Instead of casting the triggering spell in reverse, you can use a different spell from the same school. Its lowest level must be equal to or higher than the triggering spell's level. You must also succeed on a spellcasting ability check with DC 10 + the triggering spell's level, to adapt your spell to fit the triggering spell.
