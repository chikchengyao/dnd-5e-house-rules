...
These sourcebooks are used in full:
...
These sourcebooks are used in part:
...
You can choose to use either the usual proficiency bonus, or the optional rules for proficiency dice (DMG, 263).
...
You can use Intelligence-based warlocks. All your warlock features based on Charisma, including your saving throw proficiency, change to use Intelligence instead.
...
\subsection{Actions}
Actions from the Actions in Combat table are available. 
