...
When you cast a spell that has a duration of 1 minute or longer, or while such a spell (cast by you) has not ended, you can spend 1 sorcery point to double its duration, to a maximum duration of 24 hours. You can do this only once per spell. You cannot use Extended Spell if you have used another Metamagic option on it.
