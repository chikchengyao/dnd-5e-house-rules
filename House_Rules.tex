...
Some feats and their prerequisites have received balancing changes (see \pg{balance-feats}).

Parts of certain feats can also be taken as half-feats (see \pg{balance-feats-subfeats}).
...
At 10th level, you learn a second metamagic option from this list. At 17th level, you learn the last metamagic option from this list.
...
If such a conflict arises, you can swap the conflicting feat for another, or change the class of your Magic Initiate feat.
...
Lucky (PH, 167) and Savage Attacker (PH, 169) cannot be used.
