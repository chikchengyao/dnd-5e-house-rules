...
\begin{DndTable}[header=Major Feats]{llll}
    ...
    Alert & - & CHA & +5 initiative, immune to surprise, unseen attacks hit you neutrally. \\ % Weak?
    ...
    Artificer Initiate & INT 11 & - & One each of cantrip, 1st-level spell, tool proficiency. \\ % Needs to be buffed
