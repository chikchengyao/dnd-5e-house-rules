...
Use any of the three modes below.
...
and use your remaining bonus action to attack with a Spiritual Weapon. 
...
You can take a single flavour feat, or a matched pair of feats (e.g. 3A and 3B) from the Flavour Feats (Paired) table. 
Such a pair counts as a single flavour feat. 
ASIs do not apply when feats are chosen as flavour feats, but are included for reference in case you choose these feats as normal feats.
